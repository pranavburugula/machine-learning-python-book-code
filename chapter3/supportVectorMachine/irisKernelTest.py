...
print("Training...")
iris_svm.fit(X_train_std, y_train)
print("Done!")
...
def classify_iris():
    iris_predict = iris_svm.predict(X_test_std)
    print(y_test)
    print(iris_predict)
    plot_decision_regions(X=X_combined_std, y=y_combined, classifier=iris_svm, test_idx=range(105,150))
